...
export type MenuCategory = "Starters" | "Tagines" | "Couscous" | "Grills" | "Desserts" | "Drinks";
...
export const CATEGORIES: MenuCategory[] = ["Starters", "Tagines", "Couscous", "Grills", "Desserts", "Drinks"];
