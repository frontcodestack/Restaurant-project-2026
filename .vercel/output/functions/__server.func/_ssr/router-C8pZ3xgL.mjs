...
import { X, M as Menu, I as Instagram, F as Facebook, T as Twitter, Y as Youtube, a as MapPin, P as Phone, b as Mail, C as CalendarCheck } from "../_libs/lucide-react.mjs";
...
const appCss = "/assets/styles-CyQ_XM1b.css";
...
function ThemeProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeContext.Provider, { value: { theme: "light", toggle }, children });
}
function cn(...inputs) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col px-4 pb-4 pt-1 gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: LANGS.map((l) => {
                const isActive = currentLang === l.code;
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:212000000000", className: "text-sm text-foreground/60 hover:text-gold transition-colors", children: "212 000 000 000" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2.5", children: [
...
function FloatingActions() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:flex fixed bottom-5 right-5 z-40 items-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaWhatsapp, { className: "h-6 w-6" })
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "nav",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mb-4 rounded-lg bg-white/95 shadow-md backdrop-blur-sm px-3 py-2 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/menu", "aria-label": "View Menu", className: "flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium text-gray-800", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-5 w-5 text-gold" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Menu" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/reservations", "aria-label": "Reserve a Table", className: "flex items-center gap-2 rounded-md bg-gold px-4 py-2 text-sm font-semibold text-gold-foreground shadow-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarCheck, { className: "h-4 w-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Reserve" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "tel:+212000000000", "aria-label": "Contact", className: "flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium text-gray-800", children: [
...
const $$splitComponentImporter$5 = () => import("./reservations-n_y4WHhM.mjs");
...
const $$splitComponentImporter$4 = () => import("./menu-qyvm6qyH.mjs");
...
const $$splitComponentImporter$3 = () => import("./gallery-DVR3ybow.mjs");
...
const $$splitComponentImporter$2 = () => import("./contact-DXNKI_mA.mjs");
...
const $$splitComponentImporter$1 = () => import("./about-CMu_hVWl.mjs");
...
const $$splitComponentImporter = () => import("./index-BMiVilTO.mjs");
