...
function Reservations() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "hero-section relative min-h-90 sm:h-[80dvh] overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 mx-auto w-[92%] max-w-350 px-4 sm:mt-0 mt-5 sm:px-6 pt-14 sm:pt-16 md:pt-20 lg:pt-24 pb-8 sm:pb-20 md:pb-24 lg:pb-28", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          ...
          damping: 20,
          delay: 0.5
        }, className: "mt-5 sm:mt-0 sm:absolute sm:bottom-3 md:bottom-6 lg:bottom-8 sm:left-1/2 sm:z-20 sm:w-[92%] sm:max-w-3xl sm:-translate-x-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-2xl sm:rounded-full border border-gray-50/10 bg-[#1a1510]/85 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] mx-auto w-full", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 grid grid-cols-1 sm:flex sm:items-center sm:justify-between px-2 sm:px-4 md:px-6 lg:px-8 py-2 sm:py-3 md:py-3.5 gap-2 sm:gap-0", children: [{
            icon: Clock,
            value: t("reservations.info.hours"),
            label: t("reservations.info.hours_desc")
          }, {
            ...
            value: t("reservations.info.dress_code"),
            label: t("reservations.info.dress_code_desc")
          }].map((stat, i, arr) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
            opacity: 0,
            y: 10
          }, animate: {
            opacity: 1,
            ...
            py-2 sm:py-0
            ${i < arr.length - 1 ? "border-b border-gray-50/10 pb-3 sm:border-b-0 sm:border-r sm:pb-0 sm:pr-8 md:pr-10" : ""}
          `, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 sm:gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(stat.icon, { className: "h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-4 md:w-4 text-gold transition-colors duration-300 group-hover:text-gold/80 shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display whitespace-nowrap text-xs sm:text-[11px] md:text-sm lg:text-base text-white transition-colors duration-300 group-hover:text-gold leading-tight", children: stat.value })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 text-center text-[8px] sm:text-[7px] md:text-[9px] lg:text-[10px] uppercase tracking-[0.08em] md:tracking-widest text-white/50 transition-colors duration-300 group-hover:text-white/60 leading-tight", children: stat.label })
          ] }, i)) })
        ] }) })
      ] })
    ] }),
