...
function RootComponent() {
  ...
  reactExports.useEffect(() => {
    const lang = (instance.language || "fr").split("-")[0];
...
const $$splitComponentImporter$4 = () => import("./menu-lXbkDALS.mjs");
...
const $$splitComponentImporter$3 = () => import("./gallery-D8qI77hD.mjs");
