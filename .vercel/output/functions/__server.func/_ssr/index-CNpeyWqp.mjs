...
import { a as chefImg, c as courtyardImg, s as spicesImg } from "./chef-BzIPVwiL.mjs";
...
import { C as Clock, b as MapPin, P as Phone, A as ArrowRight, h as Star, U as Users, u as Music, e as CircleCheck } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "hero-section relative min-h-screen overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        delay: 1.2,
        duration: 0.8
      }, className: "absolute bottom-0 left-0 right-0 flex flex-col items-center justify-center gap-3 border-t border-gray-50/20 bg-gray-950/40 px-4 py-4 text-xs text-white/70 backdrop-blur-sm sm:flex-row sm:gap-6 sm:px-6 sm:py-3", children: [
