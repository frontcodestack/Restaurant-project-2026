...
import { c as courtyardImg, s as spicesImg, a as chefImg } from "./chef-XUuLU7uC.mjs";
...
import { c as cn } from "./router-C8pZ3xgL.mjs";
import { B as BGZ } from "./BGZ-CG54wZoT.mjs";
import { g as gallerybackground } from "./gallery-back-BSbdcsKL.mjs";
import "../_libs/i18next.mjs";
import { u as useTranslation } from "../_libs/react-i18next.mjs";
import { m as motion, A as AnimatePresence } from "../_libs/framer-motion.mjs";
import { o as Camera, B as Building2, p as Award, g as ChevronRight, h as ChevronLeft, I as Instagram, X } from "../_libs/lucide-react.mjs";
...
const hero = "/assets/hero-riad-CL9VajOJ.jpg";
const GALLERY = [
  { src: hero, alt: "Riad dining room at night", category: "Interiors", ratio: "wide" },
  { src: courtyardImg, alt: "Mosaic courtyard with fountain", category: "Interiors", ratio: "tall" },
  { src: lanternsImg, alt: "Hanging Moroccan lanterns", category: "Zellij & Details", ratio: "tall" },
  { src: spicesImg, alt: "Pyramids of Moroccan spices", category: "Zellij & Details", ratio: "square" },
  ...
  { src: chefImg, alt: "Chef portrait", category: "Interiors", ratio: "tall" }
];
...
function GalleryPage() {
  ...
  const galleryData = GALLERY.map((g, index) => ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { dir: i18n.dir(), className: "overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative bg-transparent py-10 sm:py-12 lg:py-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-0", children: [
        items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          opacity: 0,
          y: 20
        }, animate: {
          opacity: 1,
          ...
          once: true,
          margin: "-50px"
        }, className: "grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-2 lg:grid-cols-4 lg:grid-rows-[260px_260px_220px] lg:gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "popLayout", children: visibleItems.map((g, i) => {
        ...
        visibleCount < items.length && true && /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          opacity: 0,
          y: 20
        }, whileInView: {
          opacity: 1,
