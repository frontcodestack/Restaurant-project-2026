...
import { a as chefImg, s as spicesImg, c as courtyardImg } from "./chef-XUuLU7uC.mjs";
import { l as lanternsImg } from "./gallery-lanterns-IRxDErjr.mjs";
import { M as MENU } from "./menu-data-Dm_bhmZ_.mjs";
import { a as axios } from "../_libs/axios.mjs";
import { u as useTranslation } from "../_libs/react-i18next.mjs";
import { m as motion, A as AnimatePresence } from "../_libs/framer-motion.mjs";
import { c as Clock, a as MapPin, P as Phone, A as ArrowRight, f as Star, U as Users, s as Music, d as CircleCheck } from "../_libs/lucide-react.mjs";
...
const heroImg = "/assets/hero-image-DAcHx0Y8.avif";
const reservationImg = "/assets/reservation-backgorund-TeQ1p9Iy.jpg";
...
function Index() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "hero-section relative min-h-screen overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroImg, alt: t("home.hero.image_alt"), className: "absolute inset-0 h-full w-full object-cover", fetchPriority: "high" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-linear-to-b from-black/50 via-black/30 to-black/70" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 flex min-h-screen flex-col items-center justify-center px-4 pb-28 pt-20 text-center sm:px-6 sm:pb-24 md:pb-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: containerVariants, initial: "hidden", animate: "show", className: "max-w-4xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.p, { variants: heroTextVariants, className: "font-display text-xs italic text-gold/80 sm:mt-5 sm:text-sm", children: "— طعم من أصالة —" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.h1, { variants: heroTextVariants, className: "font-display text-4xl leading-[1.1] text-white sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl", children: [
          t("home.hero.title_line1"),
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "not-italic text-gold", children: t("home.hero.title_line2") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.p, { variants: heroTextVariants, className: "mx-auto mt-3 max-w-xl px-2 text-sm leading-relaxed text-white/70 sm:mt-4 sm:max-w-2xl sm:px-0 sm:text-base md:text-lg", children: t("home.hero.description") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: heroTextVariants, className: "mt-6 flex w-full flex-col items-center justify-center gap-3 px-4 sm:mt-8 sm:flex-row sm:gap-4 sm:px-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/reservations", className: "inline-flex w-full items-center justify-center gap-2 rounded-sm bg-gold px-6 py-3 text-[10px] font-semibold uppercase tracking-[0.2em] text-gold-foreground shadow-xl transition-transform hover:scale-[1.03] sm:w-auto sm:px-8 sm:py-3.5 sm:text-[11px]", children: t("home.hero.cta_primary") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/menu", className: "link-menu inline-flex w-full items-center justify-center gap-2 rounded-sm border border-white/40 bg-transparent px-6 py-3 text-[10px] font-semibold uppercase tracking-[0.2em] text-white transition-colors hover:bg-white/10 sm:w-auto sm:px-8 sm:py-3.5 sm:text-[11px]", children: t("home.hero.cta_secondary") })
        ] })
      ] }) }),
      "```tsx",
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        delay: 1.2,
        duration: 0.8
      }, className: "absolute bottom-0 left-0 right-0 flex flex-col items-center justify-center gap-3 border-t border-gray-50/20 bg-gray-950/40 px-4 py-4 text-xs text-white backdrop-blur-sm sm:flex-row sm:gap-6 sm:px-6 sm:py-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", style: {
          textShadow: "0 2px 4px rgba(0,0,0,0.9), 0 4px 12px rgba(0,0,0,0.75)"
        }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-3.5 w-3.5 text-gold", style: {
            filter: "drop-shadow(0 2px 3px rgba(0,0,0,0.9))"
          } }),
          t("home.hero.open_hours")
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden h-3 w-px bg-white/30 sm:inline-block" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", style: {
          textShadow: "0 2px 4px rgba(0,0,0,0.9), 0 4px 12px rgba(0,0,0,0.75)"
        }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3.5 w-3.5 text-gold", style: {
            filter: "drop-shadow(0 2px 3px rgba(0,0,0,0.9))"
          } }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-3.5 w-3.5 text-gold", style: {
            filter: "drop-shadow(0 2px 3px rgba(0,0,0,0.9))"
          } }),
          "212 000 000 000"
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "light relative py-10 sm:py-12 dark:bg-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-7xl px-6 lg:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: containerVariants, initial: "hidden", whileInView: "show", viewport: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-md overflow-hidden rounded-t-[50%] rounded-b-lg border-4 border-gold/20 shadow-2xl", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: containerVariants, initial: "hidden", whileInView: "show", viewport: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/about", className: "mt-6 inline-flex items-center gap-2 text-[11px] font-medium uppercase tracking-[0.2em] transition-colors hover:text-gold group", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative light py-10 sm:py-12 bg-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6 lg:px-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: containerVariants, initial: "hidden", whileInView: "show", viewport: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "\n      relative\n      overflow-hidden\n      rounded-sm\n      shadow-xl\n      group\n      lg:col-span-2\n      lg:row-span-1\n    ", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.img, { src: heroImg, alt: t("home.gallery.images.courtyard"), loading: "lazy", className: "h-full w-full object-cover", whileHover: {
          scale: 1.08
        }, transition: {
          duration: 0.7,
          ease: "easeOut"
        } }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "\n      relative\n      overflow-hidden\n      rounded-sm\n      shadow-lg\n      group\n    ", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.img, { src: lanternsImg, alt: t("home.gallery.images.lanterns"), loading: "lazy", className: "h-full w-full object-cover", whileHover: {
          scale: 1.08
        }, transition: {
          duration: 0.7,
          ease: "easeOut"
        } }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "\n      relative\n      overflow-hidden\n      rounded-sm\n      shadow-lg\n      group\n    ", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.img, { src: spicesImg, alt: t("home.gallery.images.spices"), loading: "lazy", className: "h-full w-full object-cover", whileHover: {
          scale: 1.08
        }, transition: {
          duration: 0.7,
          ease: "easeOut"
        } }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "\n      relative\n      overflow-hidden\n      rounded-sm\n      shadow-lg\n      group\n    ", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.img, { src: chefImg, alt: t("home.gallery.captions.live_music_alt"), loading: "lazy", className: "h-full w-full object-cover", whileHover: {
          scale: 1.08
        }, transition: {
          duration: 0.7,
          ease: "easeOut"
        } }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "\n      relative\n      overflow-hidden\n      rounded-sm\n      shadow-lg\n      group\n    ", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.img, { src: featured[0]?.image || courtyardImg, alt: t("home.gallery.captions.signature_dishes_alt"), loading: "lazy", className: "h-full w-full object-cover", whileHover: {
          scale: 1.08
        }, transition: {
          duration: 0.7,
          ease: "easeOut"
        } }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, className: "\n      relative\n      overflow-hidden\n      rounded-sm\n      shadow-lg\n      group\n      lg:col-span-2\n    ", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.img, { src: featured[1]?.image || spicesImg, alt: t("home.gallery.images.spices"), loading: "lazy", className: "h-full w-full object-cover", whileHover: {
          scale: 1.08
        }, transition: {
          duration: 0.7,
          ease: "easeOut"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: itemVariants, initial: "hidden", whileInView: "show", viewport: {
        once: true
      }, className: "mt-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/gallery", className: "inline-flex items-center gap-2 text-[11px] uppercase tracking-[0.2em] font-medium   hover:text-gold transition-colors group", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-10 sm:py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 lg:px-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: containerVariants, initial: "hidden", whileInView: "show", viewport: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mb-3", children: Array.from({
            length: 5
          }).map((_, j) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "h-3.5 w-3.5 fill-gold text-gold" }) }, j)) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative light py-10 sm:py-12 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.img, { src: reservationImg, alt: t("home.cta.image_alt"), className: "absolute inset-0 h-full w-full object-cover", loading: "lazy", initial: {
        scale: 1.1
      }, whileInView: {
        scale: 1
      }, viewport: {
